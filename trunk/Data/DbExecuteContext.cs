...
namespace HTB.DevFx.Data
{
	internal class DbExecuteContext : ObjectContextBase, IDbExecuteContext
	{
		...
		public IStatementSetting Statement { get; private set; }
		...
		public IDataStorage DataStorage {
			get { return this.dataStorage ?? (this.dataStorage = this.dataSession.GetDataStorage(this.Statement)); }
			private set { this.dataStorage = value; }
		}

		private IDbCommandWrap commandWrap;
		public IDbCommandWrap CommandWrap {
			get { return this.commandWrap ?? (this.commandWrap = this.dataSession.GetCommandWrap(this.Statement)); }
