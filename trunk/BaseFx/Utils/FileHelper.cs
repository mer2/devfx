	...
	public static class FileHelper
	{
		...
		public static Stream GetFileStream(string fileUri) {
			...
			if (fileUri.StartsWith("res://", true, null)) {
				...
				var resourceFullName = GetResourceName(fileUri, out resourceAssemblyName);
		...
		public static string GetFullPath(string path) {
			...
			return Path.GetFullPath(AppDomain.CurrentDomain.SetupInformation.ApplicationBase + Path.DirectorySeparatorChar + path);
		}
