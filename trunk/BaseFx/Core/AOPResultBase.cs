...
namespace HTB.DevFx.Core
{
	...
	public class AopResult<T> : IAOPResult<T>
	{
		...
		/// 隐式转换
		/// </summary>
		public static implicit operator AOPResult<T>(AopResult<T> aopResult) {
			return new AOPResult<T> {
				resultNo = aopResult.resultNo,
				resultDescription = aopResult.resultDescription,
				resultAttachObject = aopResult.resultAttachObject,
				innerAOPResult = aopResult.innerAOPResult,
				handled = aopResult.handled,
				resultData = aopResult.resultData
			};
		}
		...
		/// 隐式转换
		/// </summary>
		public static implicit operator AOPResult(AopResult<T> aopResult) {
