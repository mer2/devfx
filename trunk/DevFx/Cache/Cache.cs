...
{
	public class Cache : TimerBase, ICacheInternal
	{
		protected internal Cache() {
		}
		...
		#region Implementation of ICacheInternal
		...
		#region ICacheInternal Members

		private string cacheName;
		/// <summary>
		/// 缓存空间名称
		/// </summary>
		string ICacheInternal.CacheName {
			get { return this.cacheName; }
		}

		#endregion

		#region IInitializable<ICacheSetting> Members
