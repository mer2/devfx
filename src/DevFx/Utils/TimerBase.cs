...
namespace DevFx.Utils
{
	...
	public abstract class TimerBase
	{
		...
		/// 定时器间隔（毫秒）
		/// </summary>
		protected virtual double Interval { get; set; } = 1000;
		...
		public static TimerBase CreateDefaultTimer(double interval, Action ontimer) {
			return new DefaultTimer(interval, ontimer);
		}
		internal class DefaultTimer : TimerBase
		{
			public DefaultTimer(double interval, Action ontimer) : base(interval) {
